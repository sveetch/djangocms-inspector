...
djangocms-inspector is developed with:
...
type: ::
    ...
    git clone https://github.com/sveetch/djangocms-inspector.git
    cd djangocms-inspector
    make install

djangocms-inspector will be installed in editable mode from the
